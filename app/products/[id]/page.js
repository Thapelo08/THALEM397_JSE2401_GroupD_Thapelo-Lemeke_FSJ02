...
export default function ProductPage() {
    ...
    if (error) {
        return (
            <div className="container mx-auto px-4 py-8">
                ...
                <button onClick={handleBackToProducts} className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors duration-200">
                    Back to Products
                </button>
            </div>
        );
    ...
    return ( 
        <div className="container mx-auto px-4 py-8">
            <button onClick={handleBackToProducts} className="inline-block bg-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-300 transition-colors duration-200 mb-8">
                ← Back to Products
            </button>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <p className="mb-2"><span className="font-semibold text-gray-700 dark:text-gray-200">Category:</span> <span className="text-gray-600 dark:text-gray-300">{product.category}</span></p>
                    <p className="mb-2"><span className="font-semibold text-gray-700 dark:text-gray-200">Rating:</span> <span className="text-gray-600 dark:text-gray-300">{product.rating}/5</span></p>
                    <p className="mb-4">
